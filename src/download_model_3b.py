# -*- coding: utf-8 -*-
"""
Qwen2.5-3B-Instruct modelini (GGUF / q4_k_m) Hugging Face'ten indirir.

download_model.py ile aynı mantık: huggingface_hub'un hf_hub_download
fonksiyonu ile tek dosyayı models/ klasörüne çeker. 3B q4_k_m quantizasyonu
resmi Qwen deposunda TEK dosya halinde tutulur (7B gibi shard'lı değildir),
bu yüzden tek bir dosya indirilir.

Toplam boyut yaklaşık ~2.0 GB; indirme internet hızına göre sürebilir.
"""
...
def main():
    ...
    print("İndirme başlıyor (yaklaşık ~2.0 GB, internet hızına göre sürebilir)...\n")
